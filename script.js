...
const LanguageManager = {
    translations: {
        en: {
            ...
            footer_terms: 'Terms',
            footer_copyright: '© 2026 Kaarlight - Built for Afghanistan',
            about_title: 'About Kaarlight',
            about_lead: 'Connecting Afghan talent with local opportunities, one job at a time.',
            about_mission_title: 'Our Mission',
            about_mission_body: 'Kaarlight is a simple, fast platform designed to connect Afghan freelancers, businesses, and individuals with local job opportunities. We believe in making work accessible - whether you are a small business looking to hire, a freelancer searching for your next project, or someone offering services in your community.',
            about_why_title: 'Why Kaarlight?',
            ...
            about_questions_text: 'We would love to hear from you. Share suggestions to improve Kaarlight.',
            ...
            contact_title: 'Contact Kaarlight',
            ...
            privacy_intro: 'This Privacy Policy explains how Kaarlight collects, uses, and stores information when you use this website.',
            ...
            privacy_storage_body: 'Kaarlight uses a hybrid storage approach. Listings and some account-related features may load from cloud services when available, while browser local storage is still used for preferences, local fallbacks, and some form data on your device.',
            privacy_sharing_title: '4. Data Sharing',
            privacy_sharing_body: 'Kaarlight does not sell personal data. We only show data you choose to publish in job posts (such as contact details).',
            ...
            terms_intro: 'By accessing or using Kaarlight, you agree to these Terms of Service. If you do not agree, do not use the site.',
            terms_use_title: '1. Use of the Platform',
            terms_use_item1: 'You may use Kaarlight to browse jobs, post opportunities, and manage your profile.',
            ...
            terms_disclaimer_body: 'Kaarlight is a listing platform. We do not guarantee job quality, employer behavior, freelancer performance, or payment outcomes between users.',
            terms_liability_title: '6. Limitation of Liability',
            terms_liability_body: 'To the maximum extent allowed by law, Kaarlight is not liable for indirect or consequential losses resulting from use of the platform.',
            ...
            not_found_body: 'The page you requested is unavailable or may have been moved. Use one of the links below to continue browsing Kaarlight.',
            not_found_home: 'Go to Home',
            not_found_browse: 'Browse Jobs',
            not_found_post: 'Post a Job',
            not_found_about: 'About Kaarlight',
        ...
        fa: {
            ...
            footer_copyright: '© ۲۰۲۶ Kaarlight - ساخته‌شده برای افغانستان',
            about_title: 'درباره Kaarlight',
            about_lead: 'پیوند دادن استعدادهای افغان با فرصت‌های محلی، یک کار در هر زمان.',
            about_mission_title: 'ماموریت ما',
            about_mission_body: 'Kaarlight یک پلتفرم ساده و سریع است که فریلنسرها، کسب‌وکارها و افراد افغان را با فرصت‌های کاری محلی وصل می‌کند. ما باور داریم دسترسی به کار باید آسان باشد؛ چه شما یک کسب‌وکار کوچک برای استخدام باشید، چه فریلنسری که دنبال پروژه بعدی است، یا کسی که خدماتی در جامعه خود ارائه می‌دهد.',
            about_why_title: 'چرا Kaarlight؟',
            ...
            about_questions_text: 'خوشحال می‌شویم از شما بشنویم. پیشنهادهای خود را برای بهتر شدن Kaarlight بفرستید.',
            ...
            contact_title: 'تماس با Kaarlight',
            ...
            privacy_intro: 'این سیاست توضیح می‌دهد Kaarlight چگونه اطلاعات را هنگام استفاده از سایت جمع‌آوری، استفاده و ذخیره می‌کند.',
            ...
            privacy_storage_body: 'Kaarlight از روش ترکیبی ذخیره‌سازی استفاده می‌کند. آگهی‌ها و برخی قابلیت‌های مرتبط با حساب در صورت دسترس بودن ممکن است از سرویس‌های ابری بارگیری شوند و هم‌زمان ذخیره‌سازی مرورگر برای ترجیحات، حالت پشتیبان و بعضی داده‌های فرم روی دستگاه شما استفاده می‌شود.',
            privacy_sharing_title: '۴. اشتراک‌گذاری داده',
            privacy_sharing_body: 'Kaarlight داده شخصی را نمی‌فروشد. فقط اطلاعاتی را نشان می‌دهیم که خودتان در آگهی عمومی منتشر می‌کنید (مانند اطلاعات تماس).',
            ...
            terms_intro: 'با دسترسی یا استفاده از Kaarlight، شما این شرایط را می‌پذیرید. اگر موافق نیستید، از سایت استفاده نکنید.',
            terms_use_title: '۱. استفاده از پلتفرم',
            terms_use_item1: 'می‌توانید از Kaarlight برای دیدن کارها، ثبت فرصت‌ها و مدیریت پروفایل استفاده کنید.',
            ...
            terms_disclaimer_body: 'Kaarlight یک پلتفرم آگهی است. ما کیفیت کار، رفتار کارفرما، عملکرد فریلنسر یا نتایج پرداخت بین کاربران را تضمین نمی‌کنیم.',
            terms_liability_title: '۶. محدودیت مسئولیت',
            terms_liability_body: 'تا حدی که قانون اجازه دهد، Kaarlight در برابر خسارت‌های غیرمستقیم یا تبعی ناشی از استفاده از پلتفرم مسئول نیست.',
            ...
            not_found_about: 'درباره Kaarlight',
